...
<div class="addresses clearfix">
	...
	<div id="ordermsg" class="form-group">
        ...
        <p>W przypadku wyboru dostawy do Paczkomatu prosimy o wpisanie w komentarzu numeru paczkomatu. Numery paczkomatów można sprawdzić <a href="https://twoj.inpost.pl/pl/znajdz-punkt-inpost" target="_blank" style="text-decoration: underline">tutaj</a></p>

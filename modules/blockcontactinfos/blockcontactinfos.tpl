    ...
    <div>
        ...
        <ul class="toggle-footer">
            ...
            {if $blockcontactinfos_phone != ''}
                <li>
                    <i class="icon-phone"></i>{l s='Call us now:' mod='blockcontactinfos'}<span class="number desktopgnumber"> 
                    {$blockcontactinfos_phone|escape:'html':'UTF-8'}</span><a style="color: #fff;" class="mobilegnumber" href="tel:510877844"> 510 877 844</a>
                </li>
            {/if}
            ...
            {/if}
            <li>
                <i class="icon-credit-card"></i>ING BANK ŚLĄSKI SA<br>
                <span style="margin-left: 32px">54 1050 1399 1000 0092 2395 1048</span>
            </li>
        </ul>
    </div>
</section>

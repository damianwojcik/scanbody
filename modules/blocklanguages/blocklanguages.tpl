...
*}
	...
	<div id="languages-block-top-scanbody" class="languages-block-scanbody">
		<ul class="languages-block_ul-scanbody">
			{foreach from=$languages key=k item=language name="languages"}
				<li {if $language.iso_code == $lang_iso}class="selected"{/if}>
				{if $language.iso_code != $lang_iso}
					{assign var=indice_lang value=$language.id_lang}
					...
					{/if}
				{/if}
					<img src="{$base_dir_ssl}themes/foodstore/img/scanbody/lang_{$language.iso_code}.png" />
				{if $language.iso_code != $lang_iso}
					</a>
				{/if}
				</li>

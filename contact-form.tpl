...
<div class="col-md-3">
<div class="contactfeat">
<i class="icon-map-marker contacticon"></i>
    <p>SCAN BODY<br />Armii Krajowej 101C, 43-100 Tychy</p>
    <p>NIP: 646 254 02 31<br>REGON: 364 04 64 54</p>
</div>
</div>
<div class="col-md-3">
<div class="contactfeat">
<i class="icon-phone contacticon"></i>
    <span class="number desktopgnumber">510 877 844</span><a class="mobilegnumber" href="tel:510877844">510 877 844</a><br>
    <span class="number desktopgnumber">731 877 844</span><a class="mobilegnumber" href="tel:731877844">731 877 844</a><br>
    <span class="number desktopgnumber">533 988 980</span><a class="mobilegnumber" href="tel:599988980">599 988 980</a>
</div>
</div>
<div class="col-md-3">
<div class="contactfeat">
<i class="icon-envelope-alt contacticon"></i>
<a style="display: block;" href="mailto:biuro@scanbody.pl">biuro@scanbody.pl</a>
</div>
</div>
<div class="col-md-3">
    <div class="contactfeat">
        <i class="icon-credit-card contacticon"></i>
        <p>ING BANK ŚLĄSKI SA</p>
        54 1050 1399 1000 0092 2395 1048
    </div>
</div>
...
{else}
    ...
    <form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="contact-form-box" enctype="multipart/form-data">
        ...
        <div class="submit">
            <div class="g-recaptcha" data-sitekey="6LeJuUUUAAAAAMsS8X2BdssHcnL2z6cBrCz7c9ns"></div>
